...
#define DRAW_SPHERE_HIT(Location, Color) if(GetWorld()) DrawDebugSphere(GetWorld(), Location, 8.f, 12, Color, false, 5.f);
...
#define DRAW_BOX(Location) if (GetWorld()) DrawDebugBox(GetWorld(), Location, FVector(50.f, 50.f, 50.f), FColor::Black, true)